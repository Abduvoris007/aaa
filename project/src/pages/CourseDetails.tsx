...
const CourseDetails = () => {
  ...
  const getCourseDetails = (id: string): CourseDetails => {
    const courses: { [key: string]: CourseDetails } = {
      "1": {
        ...
        description: "Ingliz tilini online formatda noldan o'rganish. Zoom orqali jonli darslar, interaktiv mashg'ulotlar va individual yondashuv.",
        image: "/images/general-english.jpg",
        category: "language",
        schedule: [
          "Dushanba/Chorshanba/Juma - 09:00-10:30 (Zoom)",
          "Seshanba/Payshanba - Individual mashg'ulotlar"
        ],
        features: [
      ...
      "7": {
        ...
        description: "Zamonaviy web dasturlash texnologiyalari (React, Node.js, TypeScript). Real loyihalar va portfolio yaratish.",
            ...
            topics: [
              ...
              },
              {
                ...
                task: {
                  ...
                  requirements: [
                    "TypeScript bilan React komponetlar",
                    "State management",
                    "Unit testlar yozish"
                  ],
                  deadline: "3-hafta"
      ...
      "8": {
        ...
        description: "React Native va Flutter orqali mobil ilovalar yaratishni o'rganing. App Store va Play Market uchun loyihalar.",
        image: "/images/mobile-dev.jpg",
        category: "it",
        schedule: [
          "Seshanba/Payshanba - 19:00-21:00 (Live coding)",
          "Shanba - 15:00-18:00 (Amaliy mashg'ulot)"
        ],
        features: [
      ...
      "9": {
        ...
        category: "it",
        schedule: [
          "Dushanba/Chorshanba - 18:00-20:00 (Design sessions)",
          "Juma - 18:00-21:00 (Portfolio review)"
        ],
        features: [
          "Design thinking",
          "User research",
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="border-t pt-6">
                <h2 className="text-xl font-semibold mb-4">O'qituvchi</h2>
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{course.teacher.position}</p>
                    <p className="text-sm text-gray-500 mt-2">{course.teacher.bio}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold mb-6">Kurs dasturi</h2>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg shadow-md p-6 sticky top-8">
            ...
            {/* Kurs xususiyatlari */}
            <div className="mt-6">
              <h3 className="font-semibold mb-4">Kurs xususiyatlari</h3>
              <ul className="space-y-2">
      ...
      {course.category === "it" && (
        <div className="mt-8">
          <RelatedJobs courseId={course.id} isCompleted={isCompleted} />
        </div>
      )}
