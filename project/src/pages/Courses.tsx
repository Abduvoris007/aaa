...
const Courses = () => {
  ...
  const courses: Course[] = [
    // Til kurslari
    {
      ...
      description: "Zoom orqali jonli darslar, interaktiv mashg'ulotlar va individual yondashuv bilan ingliz tilini online o'rganing.",
    ...
    },
    {
      ...
      description: "IELTS imtihoniga online tayyorgarlik. Mock testlar va individual feedback. Band score 7.0+ kafolati.",
    ...
    },
    {
      ...
      duration: "6 oy",
      price: "250,000 so'm/oy",
      description: "6-12 yoshli bolalar uchun maxsus online kurs. O'yin va multimedialar orqali ingliz tilini o'rganish.",
    ...
    },
    {
      ...
      duration: "4 oy",
      price: "900,000 so'm/oy",
      description: "Xavfsizlik audit, penetration testing va xavfsizlik protokollari. Ethical hacking va himoya usullari.",
    ...
    },
    {
      ...
      description: "Docker, Kubernetes, CI/CD va Cloud platformalar. Zamonaviy DevOps amaliyotlari va avtomatlashtirish.",
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <BackButton />
      <h1 className="text-2xl sm:text-3xl font-bold mb-6">{t('courses', 'title')}</h1>
      ...
      {filteredCourses.length === 0 && (
        <div className="text-center py-12">
          <p className="text-gray-600">
            Afsuski, hech qanday kurs topilmadi.
          </p>
        </div>
      )}
