    ...
    <div className="container mx-auto px-4 py-16 dark:bg-gray-900">
      ...
      <div className="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-6">
            ...
            {contactInfo.map((info) => (
              <div key={info.type} className="flex items-center">
                <div className="flex-shrink-0">
                  <span className="flex items-center justify-center h-12 w-12 rounded-lg bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300">
                    {info.icon}
                  </span>
                </div>
                <div className="ml-4">
                  <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100">{t("contact", info.type)}</h3>
                  {info.link ? (
                    <a
                      href={info.link}
                      target="_blank"
                    ...
                    <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">{info.value}</p>
                  )}
                </div>
              </div>
            ))}
          ...
          <div className="mt-8">
            <p className="text-center text-sm text-gray-500 dark:text-gray-400">{t("contact", "workingHours")}</p>
          </div>
        </div>
      </div>
    </div>
