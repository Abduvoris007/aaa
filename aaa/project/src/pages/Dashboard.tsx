...
const Dashboard = () => {
  ...
  const [activeTab, setActiveTab] = useState<"courses" | "profile">(location.state?.activeTab || "courses")
  ...
  return (
    <div className="container mx-auto px-4 py-8 dark:bg-gray-900">
      <h1 className="text-3xl font-bold mb-6 dark:text-white">{t("dashboard", "title")}</h1>

      {/* Tab Menu */}
      <div className="flex border-b mb-8 dark:border-gray-700">
        <button
      ...
      {activeTab === "profile" && (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold mb-4 dark:text-white">Shaxsiy Ma'lumotlar</h2>
          <form onSubmit={handleProfileUpdate} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-1 dark:text-gray-300">O'rganish maqsadi</label>
              <textarea
                value={profile.goals}
      ...
      {activeTab === "courses" && (
        <div className="space-y-8">
          {/* Sotib olingan kurslar */}
          <div>
            <h2 className="text-2xl font-bold mb-4 dark:text-white">Mening kurslarim</h2>
                ...
                <div key={course.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                  <div className="p-6">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400">Progress: {course.progress}%</div>
                    </div>

                    {/* Progress Bar */}
                    <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5 mb-6">
                      <div className="bg-blue-600 h-2.5 rounded-full" style={{ width: `${course.progress}%` }} />
                    </div>

                    {/* Next Lesson */}
                    <div className="mb-4">
                      <h4 className="font-semibold mb-2 dark:text-white">Keyingi dars:</h4>
                      <div className="bg-blue-50 dark:bg-blue-900 p-4 rounded-lg">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-2">{course.nextLesson.topic}</p>
                        <a
                    ...
                    <div className="flex items-center mt-4">
                      ...
                      />
                      <div>
                        <div className="font-medium dark:text-white">{course.teacher.name}</div>
                        <div className="text-sm text-gray-600 dark:text-gray-400">O'qituvchi</div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          {/* Tavsiya etilgan kurslar */}
          <div>
            <h2 className="text-2xl font-bold mb-4 dark:text-white">Tavsiya etilgan kurslar</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="text-right">
                        <p className="text-blue-600 dark:text-blue-400 font-bold mb-2">{course.price}</p>
                        <button
