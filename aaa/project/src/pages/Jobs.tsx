...
const Jobs = () => {
      ...
      positions: [
        {
          ...
          benefits: ["Viza sponsorligi", "Bepul turar joy", "Tibbiy sug'urta", "Yo'l xarajatlari qoplanadi"],
        },
      ],
    },
    {
      ...
      positions: [
        {
          ...
          benefits: ["Tier 2 viza sponsorligi", "Relocation package", "Professional development", "Pension scheme"],
        },
      ],
    },
    {
  ...
  const renderDocumentStep = (title: string, documentType: keyof JobApplication, description: string) => (
    <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-8 text-center">{description}</p>

      <div className="space-y-6">
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Hujjat raqami</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Hujjat rasmi</label>
          <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center">
            {application[documentType].previewUrl ? (
              <div className="relative">
                <img
                  src={application[documentType].previewUrl || "/placeholder.svg"}
                  alt="Preview"
      ...
      <div className="flex justify-between mt-8">
        {currentStep > 1 && (
          <button
            ...
            className="flex items-center px-6 py-2 text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100"
          >
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 3:
        return renderDocumentStep("Diplom", "diploma", "Diplomingiz ma'lumotlarini kiriting va rasmini yuklang")
      case 4:
        return (
          <div className="max-w-2xl mx-auto">
            <h3 className="text-xl font-semibold mb-6 dark:text-white">Тасдиқлаш</h3>
            <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg mb-6">
              <h4 className="font-medium mb-4 dark:text-white">Юборилган маълумотлар:</h4>
              <ul className="space-y-2 dark:text-gray-300">
                <li>
                  <span className="font-medium">Ф.И.Ш:</span> {application.fullName}
                </li>
                <li>
                ...
                <li>
                  <span className="font-medium">Тажриба:</span> {application.experience}
                </li>
                <li>
                  <span className="font-medium">Таълим:</span> {application.education}
                </li>
                <li>
                  <span className="font-medium">Инглиз тили даражаси:</span> {application.englishLevel}
                </li>
              </ul>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          <div className="p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold dark:text-white">Ариза топшириш</h2>
              <button
  ...
  return (
    <div className="container mx-auto px-4 py-8 dark:bg-gray-900">
      <div className="flex items-center mb-8">
        <BackButton />
        <h1 className="text-3xl font-bold ml-4 dark:text-white">Хорижда ишлаш</h1>
      </div>
          ...
          >
            <div className="p-6">
              ...
              {country.positions.map((position, index) => (
                <div key={index}>
                  <h3 className="text-xl font-semibold mb-2 dark:text-white">{position.title}</h3>
                  <p className="text-blue-600 dark:text-blue-400 font-bold mb-4">{position.salary}</p>
                  <div className="mb-4">
                    <h4 className="font-medium mb-2 dark:text-white">Talablar:</h4>
                  ...
                  <div>
                    <h4 className="font-medium mb-2 dark:text-white">Imtiyozlar:</h4>
                    <ul className="space-y-1">
